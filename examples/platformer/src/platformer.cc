...
namespace platformer {
  ...
  void Platformer::initialize() noexcept {
    ...
    ResourceManager::loadShader( "../assets/shaders/spritesheet_vertex.glsl",
                                 "../assets/shaders/spritesheet_fragment.glsl", {},
                                 "sprite_sheet" );
    ...
    m_fontRenderer =
        std::make_unique<FontRenderer>( font_shader, m_settings, "../assets/fonts/arial.ttf", 42 );
